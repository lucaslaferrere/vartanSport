export const colors = {
  primary: '#1385c3',
  primaryGradient: 'linear-gradient(135deg, #7dc762 0%, #1385c3 100%)',
  primaryLight: 'rgba(19, 133, 195, 0.1)',
  primaryMedium: 'rgba(19, 133, 195, 0.15)',
  primaryHover: 'rgba(19, 133, 195, 0.08)',
  primarySelected: 'rgba(19, 133, 195, 0.12)',
  primarySelectedHover: 'rgba(19, 133, 195, 0.16)',
  primaryDark: '#0d6fa3',
