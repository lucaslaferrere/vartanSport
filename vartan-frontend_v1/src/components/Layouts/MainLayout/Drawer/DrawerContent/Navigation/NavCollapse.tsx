...
const NavCollapse = ({menu, level}:
    ...
    const borderIcon = level === 1 ?
        <i className="fa-regular fa-border-outer" style={{fontSize: '1rem'}}/> : false;
    const menuIcon = menu.icon ?
        <Icon style={{fontSize: drawerOpen ? '1rem' : '1rem', overflow: 'visible'}} className={menu.icon}/> : borderIcon;
