...
type FormaPago struct {
	...
	ComisionPorcentaje float64 `gorm:"type:decimal(5,2);not null;default:0;check:comision_porcentaje >= 0 AND comision_porcentaje <= 100" json:"comision_porcentaje"`
}
...
type Venta struct {
	...
	ComisionPorcentajeAplicado float64    `gorm:"type:decimal(5,2);not null;default:0;check:comision_porcentaje_aplicado >= 0 AND comision_porcentaje_aplicado <= 100" json:"comision_porcentaje_aplicado"`
